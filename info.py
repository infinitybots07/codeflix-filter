...
PICS = (environ.get('PICS', 'https://ibb.co/d0DQYyb5 https://ibb.co/1GFwHBMy')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/Wdj.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://envs.sh/Hrp.mp4")
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001808193316'))
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002141309911'))
auth_channel = environ.get('AUTH_CHANNEL', '-1001950005931')  # Channel/Group ID for force sub
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1001950005931').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1001950005931 -1001731320015').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
