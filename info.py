...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6969742016').split()] # Replace with the actual admin ID(s) to add
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Free Ka Maal")
...
OWNERID = int(os.environ.get('OWNERID', '6969742016'))  # Replace with the actual admin ID
