...
async def refercall(bot, query):
    btn = [[
        ...
        InlineKeyboardButton('ɢᴏ ʙᴀᴄᴋ', callback_data='premium_info')
    ]]
...
async def next_page(bot, query):
    ...
    # Auto delete message formatting
    del_msg = f"<b><blockquote>⚠️ ᴛʜɪs ᴍᴇssᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏ ᴅᴇʟᴇᴛᴇ ᴀꜰᴛᴇʀ <code>{infinity_time(DELETE_TIME)}</code> ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ ɪssᴜᴇs.</blockquote></b>" if settings["auto_delete"] else ''
    ...
    if not settings["button"]:
        ...
        try:
            await query.message.edit_text(text=cap + del_msg, reply_markup=InlineKeyboardMarkup(btn), disable_web_page_preview=True)
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        if channels:
            ...
            if btn:
                await query.answer(
                    ...
                    "Yᴏᴜ ʜᴀᴠᴇ ɴᴏᴛ ᴊᴏɪɴᴇᴅ ᴀʟʟ ʀᴇǫᴜᴇꜱᴛᴇᴅ ᴜᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟs.\n"
        ...
        btn = [[
                ...
                InlineKeyboardButton("ᴛʏᴘᴇ ᴄᴏʀʀᴇᴄᴛ sᴘᴇʟʟɪɴɢ", callback_data=f"Type_Correct_Spelling#{from_user}")
             ],[
        ...
        ident, from_user = query.data.split("#")
        btn = [[
                InlineKeyboardButton("⚜️ ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ʜɪɴᴅɪ ⚜️", callback_data=f"unalert#{from_user}")
              ]]
        btn2 = [[
                 InlineKeyboardButton('ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ', url=link.invite_link),
                 InlineKeyboardButton("ᴠɪᴇᴡ ꜱᴛᴀᴛᴜꜱ", url=f"{query.message.link}")
        ...
        buttons = [[
            InlineKeyboardButton('× ᴀʟʟ ᴏᴜʀ ʟɪɴᴋꜱ ×', url="https://t.me/+JWsoDEJEB9EyNDU1")
       ],[
            InlineKeyboardButton('• ɢʀᴏᴜᴘ •', url="https://t.me/+YqSLcYCIIKxjODRl"),
            InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs •', url="t.me/infinity_botzz")
       ],[
            InlineKeyboardButton('• sᴇʀɪᴇs •', url="https://t.me/+goYMUygBL383ZTc8"),
            InlineKeyboardButton('• ᴍᴏᴠɪᴇ •', url="https://t.me/+BJfqwUjbkQFmNTU1")
       ],[
            InlineKeyboardButton('• ᴀɴɪᴍᴇ ᴄʀᴜɪsᴇ •', url="https://t.me/infinity_uploads")
       ],[ 
            InlineKeyboardButton('• ʙᴀᴄᴋ •', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ɴᴇᴛᴡᴏʀᴋ •', url="https://t.me/hd_movies_hub01/7")
        ], [
            InlineKeyboardButton('• ʙᴀᴄᴋ •', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        if not settings["button"]:
            cap+="\n\n<b>📚 <u>ʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛᴇᴅ ꜰɪʟᴇꜱ</u> 👇\n\n</b>"
            for file in files:
                #cap += f"<b>📁 <a href='https://telegram.me/{temp.U_NAME}?start=files_{file.file_id}'>{' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@') and not x.startswith('www.'), file.file_name.split()))}</a> ▷ [{get_size(file.file_size)}]\n\n</b>"
                cap += f"<b>📁 [{get_size(file.file_size)}] ▷ <a href='https://telegram.me/{temp.U_NAME}?start=files_{file.file_id}'>{' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@') and not x.startswith('www.'), file.file_name.split()))}</a>\n\n</b>"
                #cap += f"<b>\n<a href='https://telegram.me/{temp.U_NAME}?start=files_{file.file_id}'> 📁 {get_size(file.file_size)} ▷ {' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@') and not x.startswith('www.'), file.file_name.split()))}\n</a></b>"
    else:
        if settings["button"]:
            cap = f"<b>🏷 ᴛɪᴛʟᴇ : <code>{search}</code>\n🧱 ᴛᴏᴛᴀʟ ꜰɪʟᴇꜱ : <code>{total_results}</code>\n⏰ ʀᴇsᴜʟᴛ ɪɴ : <code>{remaining_seconds} Sᴇᴄᴏɴᴅs</code>\n📝 ʀᴇǫᴜᴇsᴛᴇᴅ ʙʏ : {message.from_user.mention}\n\nʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛᴇᴅ ꜰɪʟᴇꜱ ᴀʀᴇ ʙᴇʟᴏᴡ 👇 \n\n</b>"
        else:
            cap = f"<b>🏷 ᴛɪᴛʟᴇ : <code>{search}</code>\n🧱 ᴛᴏᴛᴀʟ ꜰɪʟᴇꜱ : <code>{total_results}</code>\n⏰ ʀᴇsᴜʟᴛ ɪɴ : <code>{remaining_seconds} Sᴇᴄᴏɴᴅs</code>\n📝 ʀᴇǫᴜᴇsᴛᴇᴅ ʙʏ : {message.from_user.mention}\n\nʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛᴇᴅ ꜰɪʟᴇꜱ ᴀʀᴇ ʙᴇʟᴏᴡ 👇 \n\n</b>"
            for file in files:
                #cap += f"<b>📁 <a href='https://telegram.me/{temp.U_NAME}?start=files_{file.file_id}'>{' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@') and not x.startswith('www.'), file.file_name.split()))}</a> ▷ [{get_size(file.file_size)}]\n\n</b>"
    ...
    if imdb and imdb.get('poster'):
        try:
            hehe = await message.reply_photo(photo=imdb.get('poster'), caption=cap + del_msg, reply_markup=InlineKeyboardMarkup(btn))
            await m.delete()
            try:
            ...
            hmm = await message.reply_photo(photo=poster, caption=cap + del_msg, reply_markup=InlineKeyboardMarkup(btn))
            await m.delete()
            try:
               if settings['auto_delete']:
                    await asyncio.sleep(DELETE_TIME)
            ...
            logger.exception(e)
            m=await message.reply_text("🔎") 
            fek = await message.reply_text(text=cap + del_msg, reply_markup=InlineKeyboardMarkup(btn))
            await m.delete()
            try:
                if settings['auto_delete']:
                    await asyncio.sleep(DELETE_TIME)
        ...
        fuk = await message.reply_text(text=cap + del_msg, reply_markup=InlineKeyboardMarkup(btn), disable_web_page_preview=True)
        await m.delete()
        try:
            if settings['auto_delete']:
                await asyncio.sleep(DELETE_TIME)
